...
class SyllabusesControllerTest < ActionController::TestCase
  ...
  test "should create syllabus" do
    assert_difference('Syllabus.count') do
      post :create, syllabus: { course_id: @syllabus.course_id, description: @syllabus.description, name: @syllabus.name }
    end
  ...
  test "should update syllabus" do
    patch :update, id: @syllabus, syllabus: { course_id: @syllabus.course_id, description: @syllabus.description, name: @syllabus.name }
    assert_redirected_to syllabus_path(assigns(:syllabus))
  end
